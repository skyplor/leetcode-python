...
class MaximumFrequencyOfAnElementAfterPerformingOperationsISolution {
    ...
    public static void main(String[] args) {
        MaximumFrequencyOfAnElementAfterPerformingOperationsISolution sol = new MaximumFrequencyOfAnElementAfterPerformingOperationsISolution();
