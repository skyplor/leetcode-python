...
class FindSumOfArrayProductOfMagicalSequences {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "Output: " + sol.magicalSum(5, 5, new int[] { 1, 10, 100, 10000, 1000000 }) + ", expected: 991600007");
        System.out.println("Output: " + sol.magicalSum(2, 2, new int[] { 5, 4, 3, 2, 1 }) + ", expected: 170");
        System.out.println("Output: " + sol.magicalSum(1, 1, new int[] { 28 }) + ", expected: 28");
    }
}
